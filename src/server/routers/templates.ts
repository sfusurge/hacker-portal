...
export const welcomeSparkhacksTemplate = `<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        <!-- NAME: 1 COLUMN -->
        <!--[if gte mso 15]>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1 class="null" data-pm-slice="1 1 []" style="text-align: center;"><img data-file-id="14712216" height="114" src="https://mcusercontent.com/33345c9bc17f10bac6afdd0ac/images/16c1e05a-538d-229b-6441-dff5c0aad03d.png" style="border: 0px initial ; width: 660px; height: 114px; margin: 0px;" width="660"></h1>

<p><strong id="docs-internal-guid-2dfd2ce2-7fff-4906-5b8f-c9128358502a">Hello Friend 🥳</strong><br>
<br>
Thanks so much for applying to SparkJam, we’ve received your application, and our team of otters will be reviewing it in the coming days.<br>
<br>
All RSVP notifications will be going out on <em><strong>May 5th</strong></em>, but if you have any questions regarding the event, don’t hesitate to reach out to us at <a href="mailto:sfusurge@gmail.com" target="_blank">sfusurge@gmail.com</a> or <a href="https://www.instagram.com/sfusurge/" target="_blank">@sfusurge</a> on instagram.<br>
<br>
In the meantime, check out more of what is planned for SparkJam on our <a href="https://sparkjam.design/" target="_blank">website</a>, and maybe even try out some of the fun interactive games <span style="color:#808080"><em>(Sparky told me that there might be a prize for the highest score in the Suika game…).</em></span><br>
<br>
Well now that you’ve got a few days to think about it… <strong>what’s your spark?</strong></p>

<p data-pm-slice="0 0 []">Talk soon,<br>
The SparkJam Team<br>
<span style="color:#808080">(SFU Surge)</span></p>
&nbsp;
