...
export default function Calendar() {
    const _events: CalendarEventType[] = [
        ...
        },
        {
            ...
            description:
                'Plan and schedule social media posts to promote the event.',
        ...
        },
        {
            ...
            description:
                'Confirm tools and technologies participants will use.',
        ...
        },
        {
            ...
            description:
                'Collect sponsor banners, logos, and promotional materials.',
        ...
        },
        {
            ...
            description:
                'Draft the detailed event-day schedule with buffer times.',
        ...
        },
        {
            ...
            description:
                'Go through the checklist to ensure everything is on track.',
