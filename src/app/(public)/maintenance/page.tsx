...
export default function Maintenance() {
    return (
        <>
            <div className="w-full h-screen justify-center items-center flex flex-col bg-[#0C0C0D]">
                <div
                    className="z-0 -translate-y-1/2 absolute w-screen h-screen flex-shrink-0 opacity-60
                ...
                >
                    ...
                    <div className="flex flex-col w-full gap-2">
                        <h1 className="text-white text-xl text-balance font-medium leading-tightest">
                            We’ve got something cooking
                        </h1>
                        <h3 className="text-sm text-balance font-light leading-5 tracking-tightest text-white/60 pr-3 pl-3">
