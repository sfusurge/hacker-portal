...
export default function ReviewApplicationsTable({
  ...
  function IndeterminateCheckbox({
    ...
    useEffect(() => {
      if (ref.current) {
        ref.current.indeterminate = (!rest.checked && indeterminate) || false;
      }
            ...
            <div className="flex  items-center gap-1">
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  value={table.getState().pagination.pageIndex + 1} // Bind to the current page index
                  onChange={(e) => {
        ...
        >
          ...
          >
            ...
            <button
              ...
              type="button"
              onClick={() =>
                handleSendingEmails(table.getSelectedRowModel().rows, emailType)
              }
            >
              Send Emails
            </button>
