  ...
  return (
    <div className="flex flex-col z-20 w-5/12 h-screen bg-neutral-850 p-8 rounded-lg gap-4 shadow-lg border border-neutral-600/60">
      <div className="flex flex-row items-center justify-between mb-4">
        <h1 className="text-xl font-bold text-white">Hacker Application</h1>
      ...
      <ScrollArea className="flex flex-col p-2 h-4/12 w-full bg-neutral-900 rounded-lg shadow-inner border border-neutral-600/60">
        <div className="space-y-6 p-5">
          ...
          <div className="grid gap-4">
            ...
            <div>
              <Label className="text-white/60" htmlFor="enrollmentYear">
                Enrollment Year
              </Label>
              <Input
                type="number"
          ...
          >
            <Label className="text-white/60">Participant Type</Label>
            ...
            <div className="flex flex-col gap-2 w-fit">
              {['Yes', 'No'].map((option) => (
                <div
                  ...
                  key={option}
                  onClick={() => setPhotoConsent(option === 'Yes')}
                >
                  <RadioGroupItem
                    value={option}
                    id={option}
                    onChange={() => setPhotoConsent(option === 'Yes')}
                    className={`appearance-none w-5 h-5 rounded-full border ${
                      (photoConsent ? 'Yes' : 'No') === option
                        ? 'bg-brand-500 border-blue-800'
                        : 'bg-neutral-700 border-neutral-500'
      ...
      <section className="mt-6 p-4 border border-neutral-600/30 rounded-xl">
        ...
        <div className="flex flex-wrap gap-5">
          <Button
            ...
            onClick={() => handleChangeApplicationStatus('Accepted')}
          >
            Accepted
          </Button>
          <Button
            ...
            onClick={() => handleChangeApplicationStatus('Rejected')}
          >
            Rejected
          </Button>
          <Button
            ...
            onClick={() => handleChangeApplicationStatus('Waitlisted')}
          >
            Waitlisted
          </Button>
          <Button
